    ...
    <div className="space-y-5 pb-28">
      ...
      {activeTab === 'gaji' && (
        <div className="space-y-5">
          {/* Period Selection Pill Row */}
          <div className="space-y-2">
            <span className="text-[10px] uppercase font-black tracking-wider text-slate-400 block px-1">
              Pilih Periode Mingguan:
            </span>
            <div className="flex gap-2 overflow-x-auto pb-2 px-1 scrollbar-thin scrollbar-thumb-slate-800 scrollbar-track-transparent">
              {weekRanges.map((w) => {
                ...
                return (
                  <button
                    ...
                    className={`shrink-0 px-3.5 py-2.5 rounded-2xl border text-left transition-all ${
                      isSelected
                        ? 'bg-gradient-to-b from-slate-900 to-slate-950 border-emerald-500/40 text-white shadow-md shadow-emerald-950/20'
                        : 'bg-slate-950/40 border-slate-900/80 text-slate-400 hover:border-slate-800 hover:text-slate-200'
                    }`}
                  >
                    <div className="flex items-center gap-1.5 mb-1">
                      <Calendar className={`w-3.5 h-3.5 ${isSelected ? 'text-emerald-400 animate-pulse' : 'text-slate-500'}`} />
                      <span className="text-[8.5px] font-black uppercase tracking-wider">
                        {w.isCurrentWeek ? 'Minggu Ini' : w.isPreviousWeek ? 'Minggu Lalu' : 'Arsip'}
                      </span>
                    </div>
                    <span className="text-[11px] font-extrabold block">{w.label}</span>
                  </button>
                );
              })}
            </div>
          ...
          <div className="relative">
            ...
            <div className="p-5 rounded-3xl bg-slate-950/95 border border-slate-850/90 shadow-2xl space-y-5 relative">
              ...
              <div className="flex items-start justify-between pb-3 border-b border-dashed border-slate-800/80">
                <div>
                  ...
                  <p className="text-[9px] text-slate-500 font-medium">
                    AzurLize Team System • {selectedWeekObj.isCurrentWeek ? 'Minggu Ini' : selectedWeekObj.isPreviousWeek ? 'Minggu Lalu' : 'Arsip'}
                  </p>
                </div>
                
                <button
                  onClick={() => handleCopySlip(selectedWeekObj, finalStats, !selectedWeekObj.isCurrentWeek)}
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div className="space-y-0.5">
                  ...
                  <span className="font-extrabold text-white truncate block">{selectedWeekObj.label}</span>
                </div>
                <div className="space-y-0.5">
                ...
                <div className="space-y-0.5">
                  ...
                  <span className="font-extrabold text-white flex items-center gap-1">
                    ...
                    <span>{finalStats.hriKerja} Hari</span>
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="bg-emerald-950/20 border border-emerald-500/10 p-2 rounded-xl text-center">
                  ...
                  <span className="text-xs font-black text-emerald-400 mt-0.5 block">{finalStats.tingkatPenerimaan}%</span>
                </div>
              ...
              {/* Detailed Financial Breakdown (Fields 14-20) */}
              <div className="space-y-2">
                ...
                <div className="space-y-1.5 text-xs text-slate-400">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-extrabold text-emerald-400">{formatIDR(finalStats.komisi)}</span>
                  </div>
                  ...
                  <div className="pt-3 border-t border-slate-800 flex justify-between items-center text-white">
                    ...
                    <span className="text-xl font-black text-emerald-400">{formatIDR(finalStats.totalGajiNet)}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {showConfig && (
              ...
              >
                <div className="bg-blue-500/5 border border-blue-500/10 rounded-2xl p-3 flex gap-2 text-[10px] text-slate-400 leading-normal">
                  ...
                  <p>
                    Ubah parameter perhitungan komisi kerja di bawah ini. Nilai kosong akan dihitung otomatis secara realtime dari data laporan disetujui (<span className="text-emerald-400 font-bold">ACC</span>) untuk periode {selectedWeekObj.label}.
                  </p>
                </div>
                ...
                <div className="space-y-3.5">
                  <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                    Override Performa Manual ({selectedWeekObj.isCurrentWeek ? 'Minggu Ini' : selectedWeekObj.isPreviousWeek ? 'Minggu Lalu' : 'Arsip'}):
                  </h4>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        placeholder={`${autoStats.hriKerja} (Auto)`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder={`${autoStats.totalPostingan} (Auto)`}
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs text-white"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        placeholder={`${autoStats.deklarasiT0} (Auto)`}
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs text-white"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        placeholder={`${autoStats.sebenarnyaT0} (Auto)`}
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs text-white"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder={`${autoStats.deklarasiV0} (Auto)`}
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs text-white"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        placeholder={`${autoStats.sebenarnyaV0} (Auto)`}
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs text-white"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        placeholder={`${autoStats.tingkatPenerimaan}% (Auto)`}
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs text-white"
                      />
                    </div>
                  </div>
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center pt-2.5">
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            handleInspectWeek(week);
                          }}
                          className="flex items-center gap-1 text-[9px] font-black py-1 px-2.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white shadow-lg shadow-blue-900/20 transition-all"
                        >
